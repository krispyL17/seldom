...
export function SoccerOverviewPage() {
  ...
  return (
    <div className="perf-page-viewport perf-page-fit grid grid-cols-1 gap-2 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
      <div className="flex flex-col gap-2">
        <Panel title="At a glance" subtitle="Focus and recent activity" className="shrink-0">
          ...
          {(runsLoading || matchesLoading) && (
            <p className="mt-1 text-xs text-[var(--color-text-tertiary)]">Loading activity…</p>
          )}
        </Panel>
